...
document.getElementById('add').addEventListener('click', function() {
    ...
    if (value) addItemTodo(value); //if there is an item
...
//the item should be added to completed list or to habits list    
    var target = (id === 'habits') ? document.getElementById('completed'):document.getElementById('habits');
...
/* or document.getElementById('add').onclick */ 
